export default function validate(values) {
    //input : values={field : value , field2 : value} eg{email : zachary@var-x.com , phone : 5555-5555}

    //output : {field : value } eg {email: true , phone : true}
    const validators = {
